...
const LEFT_FAQS = [
  { q: "How much does junk removal cost?", a: <>Flat rate: $200/hr per man. Two-man crew is $400/hr. Dump fees included (an industry first). 1 hour minimum. See our full <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">pricing breakdown</Link>.</> },
  ...
  { q: "Do you offer same-day junk removal?", a: <>Yes. Call before noon and we can typically have a crew at your door within 2-4 hours. Same rate as any other day — $200/hr per man, no premium for same-day. <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">See pricing</Link>.</> },
  ...
  { q: "Are you licensed and insured?", a: <>Fully licensed, bonded, and insured in every state. Every contractor is background-checked, with verified vehicle insurance. We carry comprehensive liability coverage. Learn more <Link href="/about" className="text-teal-700 font-semibold hover:underline">about our team</Link>.</> },
...
const RIGHT_FAQS = [
  { q: "How is your pricing different from other junk removal companies?", a: <>We charge $200/hr per man and credit you 50% (when applicable) of resale value on your items. Other companies charge flat-rate volume pricing and keep 100% of resale profit themselves. See our <Link href="/pricing" className="text-teal-700 font-semibold hover:underline">pricing breakdown</Link>.</> },
  ...
  { q: "Do you provide certificates of insurance?", a: <>Yes. COIs available on request for commercial customers, property managers, and realtors. We carry comprehensive general liability, and contractors carry their own verified commercial auto. <Link href="/contact-we-pay-you-junk-removal-today" className="text-teal-700 font-semibold hover:underline">Request a COI</Link>.</> },
  ...
  { q: "Are you hiring?", a: <>Yes — 1099 contractors in all 50 states. Must own a truck or trailer. $100/hr per man + 50% of items we resell. See <Link href="/careers" className="text-teal-700 font-semibold hover:underline">open positions</Link>.</> },
