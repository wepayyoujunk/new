      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-10 space-y-5 text-base leading-relaxed text-slate-700">
            <p>starting at $100/hr means starting at $100/hr. Not $100 plus a fuel surcharge. Not $100 plus dump fees. Not $100 for the first hour then $150 after that. Not $100 base with a $50 &quot;heavy item fee&quot; when we pick up your fridge. Our crew pulls up, works the job, and the clock runs at starting at $100/hr from the moment they start loading until they finish the walkthrough. If it takes 47 minutes, you pay the 1 hour minimum. If it takes 2 hours and 15 minutes, you pay $225. Simple.</p>
