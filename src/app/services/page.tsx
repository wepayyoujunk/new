...
export const metadata: Metadata = {
  title: "Junk Removal Services — 34 Service Types Nationwide | $200/hr per man",
  description: "34 specialized junk removal services with 50% Resale Credit (when applicable). Residential cleanouts, furniture removal, estate cleanouts, construction debris, commercial services, and more. $200/hr per man, dump fees included.",
    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 pt-36 pb-16 sm:pt-44 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
            {SERVICES.length} specialized services. $200/hr per man flat rate with dump fees included. 1 hour minimum. Every item with resale value earns you 50% credit toward your bill — or we pay you the difference.
          </p>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <h2 className="mt-3 text-center text-3xl font-bold text-slate-900 font-heading">How It Works When We Show Up at Your Door — $200/hr per man, We Handle Everything</h2>
      ...
      <section className="bg-section-white py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <h2 className="mt-3 text-center text-3xl font-bold text-slate-900 font-heading">How Junk Removal Pricing Works — $200/hr per man Flat Rate With 50% Resale Credit (when applicable) on All {SERVICES.length} Services</h2>
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            <p><strong>The rate:</strong> $200 per hour per man, 1 hour minimum. This covers everything — labor, truck, fuel, dump fees, transfer station costs, and disposal. There are no add-on charges for heavy items, stairs, long carries, distance to the dump, demolition work, or anything else. If our two-man crew works 2.5 hours, you pay $1,000 before credits. If a one-man crew finishes in 45 minutes, you pay the $200 minimum.</p>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-700 via-teal-600 to-teal-800 py-16">
        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          <h2 className="text-center text-3xl font-bold text-white sm:text-4xl font-heading">
            Book Any of Our {SERVICES.length} Services — $200/hr per man Nationwide
          </h2>
          <p className="mx-auto mt-6 max-w-2xl text-lg text-white/80">
