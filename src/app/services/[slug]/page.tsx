      ...
      <section className="bg-section-teal py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate-700">
            ...
            <p>With our {service.title.toLowerCase()} service, the economics are completely different. You pay a transparent hourly rate — starting at $100/hr for our crew, starting at $100/hr for our crew, or starting at $100/hr for our crew. Dump fees, transfer station costs, and all disposal charges are included. As our crew loads your items, they identify everything with resale value and appraise it at current fair market rates. You receive 50% of each item&apos;s appraised value as an immediate credit on your bill. If the total credits exceed the total bill, we pay you the difference.</p>
