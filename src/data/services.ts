...
export function getExtendedContent(service: Service): string[] {
  ...
  return [
    ...
    `We encourage anyone considering ${tl} to call us at (888) 831-3001 for a free, no-obligation consultation. We'll discuss your specific situation, confirm the starting at $100/hr rate, estimate the time required, and give you a clear sense of what to expect in terms of cost and potential resale credits. There's no pressure, no sales pitch — just honest information to help you make the best decision. Whether you book with us today, next week, or never, you'll walk away from the call knowing exactly what professional ${tl} costs and how much your items might be worth.`,
