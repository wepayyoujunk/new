  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `Preparation is the difference between a $100 junk removal and a $300 one. The more organized you are before our ${cityName} crew arrives, the faster they work — and since you're paying $200/hr per man, faster means cheaper. Here's how ${cityName} residents can prepare for a smooth, cost-effective cleanout.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Our 50% Resale Credit (when applicable) on valuable items is what makes our service different in the ${cityName} market. You pay $200/hr per man, dump fees included, and credits for items with resale value come right off the top.`,
        ],
      },
      {
    ...
    extraSections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `We Pay You in ${cityName}: $200/hr per man, dump fees included, 50% resale credit (when applicable) on valuable items. A 2-hour job with a two-man crew = $800 before credits, and $300 in resale credits brings that to $500. On big cleanouts where the credit total exceeds the bill, we cut you a check instead.`,
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          `Every contractor who shows up at your ${cityName} property is background-checked, vetted for vehicle and insurance, and trained in our appraisal and customer service protocols. They carry identification and bring their own commercial-grade truck or trailer.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Total real cost of DIY in ${cityName}: $270-$780. Our crew handles the same job in 2-3 hours $200/hr per man. Before credits, that is $200-$750. After resale credits (which DIY generates zero of because everything goes to the dump), most ${cityName} customers pay $100-$500 out of pocket. AND they did not lift a finger, did not spend their Saturday at the dump, and did not risk injuring their back carrying a dresser down the stairs.`,
      ...
      },
      {
        ...
        paragraphs: [
          `How much does junk removal cost in ${cityName}? Flat rate: $200/hr per man, dump fees included (an industry first). 1 hour minimum. Most residential jobs in ${cityName} use a two-man crew and take 1.5-3 hours. After 50% resale credits (when applicable), credits often shave a real chunk off your bill or — on heavy-value cleanouts — exceed it.`,
