...
export function statePageContent(stateName: string, stateAbbr: string, cities: { name: string; slug: string }[]) {
  ...
  return {
    ...
    metaDescription: `Professional junk removal in ${cities.length}+ cities across ${stateName}. $200/hr per man with dump fees included. We credit you 50% (when applicable) of resale value (when applicable) on items worth something. Same-day available.`,
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `The process is simple no matter where you are in ${stateName}. Call us at ${PHONE} and describe what you need removed. We'll confirm pricing based on the volume and type of items. You pick your crew size at $200/hr per man — one for small jobs, two for most cleanouts, three for big lifts — and we schedule a time that works for you. Same-day appointments are available in most ${stateAbbr} cities when you call before noon. We operate 7AM-8PM daily, 7 days a week including weekends and holidays.`,
      ...
      },
      {
        ...
        paragraphs: [
          `Our pricing is the same across all ${cities.length} cities in ${stateName}: $200/hr per man, dump fees included, 1 hour minimum. Transfer station costs and disposal charges are all baked in (an industry first). There are no hidden fees, no volume-based pricing, and no surge pricing. The rate you're quoted is the rate you pay.`,
          `A one-man crew at $200/hr is ideal for small jobs — a few pieces of furniture, some electronics, a light cleanout, or single-item pickups like a mattress or refrigerator. Most one-man jobs in ${stateName} take 1-2 hours. A two-man crew at $400/hr is our most common option for ${stateName} customers — it handles full garage cleanouts, basement clearing, furniture removal, appliance hauling, estate work, and anything heavy. Most two-man jobs take 1.5-3 hours.`,
...
export function cityPageContent(cityName: string, stateName: string, stateAbbr: string, stateSlug: string, otherCities: { name: string; slug: string }[]) {
  ...
  return {
    ...
    metaDescription: `Professional junk removal in ${cityName}, ${stateAbbr}. $200/hr per man with dump fees included. We credit you 50% (when applicable) of resale value (when applicable). Same-day available. Call ${PHONE}.`,
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Step 2: Pick your crew size at $200/hr per man — one man for small jobs, two for most residential cleanouts, three for heavy or time-sensitive work. Schedule a time that works for you. Same-day slots are available in ${cityName} for calls placed before noon. We offer 2-hour arrival windows so you're not stuck waiting all day.`,
      ...
      },
      {
        ...
        paragraphs: [
          `Pricing in ${cityName} is straightforward: $200/hr per man, dump fees included (an industry first), 1 hour minimum. All valuable items credited at 50% resale value (when applicable). No hidden fees, no volume pricing, no minimum truck-load charges, no contracts.`,
          `Most residential jobs in ${cityName} use a two-man crew and take 1.5-3 hours. That's $600-$1,200 before credits. Resale credits come off the top — and on estate cleanouts and office jobs with high-value items, those credits frequently exceed the bill, meaning we cut you a check at the end of the job.`,
          `For smaller jobs in ${cityName} — a single item pickup, a few boxes, light furniture — a one-man crew usually handles it in under an hour, putting your total at $200 before any credits. For full cleanouts and heavy items, a two-man crew at $400/hr is our most common option. For large-scale projects — full estate clearing, warehouse jobs, multi-day office cleanouts — larger crews finish faster while you still pay the same $200/hr per man.`,
        ],
      },
      {
...
export function cityServicePageContent(cityName: string, stateName: string, stateAbbr: string, service: Service) {
  ...
  return {
    ...
    metaDescription: `${service.title} in ${cityName}, ${stateAbbr}. $200/hr per man, dump fees included. 50% Resale Credit (when applicable) on valuable items. Same-day available. Call ${PHONE}.`,
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `Step 2 — Choose Your Crew: Pick the crew size that fits your ${svcLower} job. Our crew handles light ${svcLower} work — a few items, small spaces, simple access. Our crew $200/hr per man is our most popular for ${svcLower} in ${cityName} — it handles most residential jobs efficiently with one person loading while the other sorts and appraises. Our crew $200/hr per man tackles large ${svcLower} projects fast — full property clears, heavy items, and time-sensitive work.`,
      ...
      },
      {
        ...
        paragraphs: [
          `${service.title} pricing in ${cityName} follows our standard transparent structure: $200/hr per man, 1 hour minimum, dump fees included (an industry first). All disposal costs and transfer station fees are baked in. All items with resale value are credited to you at 50% of fair market value (when applicable). There are no hidden charges, minimums, or volume-based fees.`,
