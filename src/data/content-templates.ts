  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `The process is simple no matter where you are in ${stateName}. Call us at ${PHONE} and describe what you need removed. We'll confirm the starting at $100/hr rate based on the volume and type of items. You book your — our crew at starting at $100/hr, our crew at starting at $100/hr, or our crew at starting at $100/hr — and we schedule a time that works for you. Same-day appointments are available in most ${stateAbbr} cities when you call before noon. We operate 7AM-8PM daily, 7 days a week including weekends and holidays.`,
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `Step 1: Call us at ${PHONE} and tell us what you need removed from your ${cityName} property. Describe the items, the quantity, and any access considerations (stairs, narrow hallways, heavy items, etc.). Our team will ask a few quick questions to understand the scope and confirm the starting at $100/hr rate for your job.`,
          `Step 2: Pick your crew — our crew at starting at $100/hr for small jobs, our crew at starting at $100/hr for most residential work, or our crew at starting at $100/hr for large-scale cleanouts. Schedule a time that works for you. Same-day slots are available in ${cityName} for calls placed before noon. We offer 2-hour arrival windows so you're not stuck waiting all day.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `For smaller jobs in ${cityName} — a single item pickup, a few boxes, light furniture — our crew at starting at $100/hr usually handles it in under an hour, putting your total at $100 before any credits. For large-scale projects — full estate clearing, warehouse jobs, multi-day office cleanouts — our crew at starting at $100/hr offers the best value per hour of work completed.`,
        ],
      },
      {
  ...
  return {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `Step 1 — Call and Describe: Call us at ${PHONE} and describe your ${svcLower} job in ${cityName}. Tell us what items need to go, approximately how many, whether there are any access challenges (stairs, narrow doorways, long driveways, gated communities), and your preferred timing. Our booking team will confirm the starting at $100/hr rate based on your description and lock in your appointment.`,
          `Step 2 — Choose Your Crew: Pick the crew size that fits your ${svcLower} job. Our crew handles light ${svcLower} work — a few items, small spaces, simple access. Our crew at starting at $100/hr is our most popular for ${svcLower} in ${cityName} — it handles most residential jobs efficiently with one person loading while the other sorts and appraises. Our crew at starting at $100/hr tackles large ${svcLower} projects fast — full property clears, heavy items, and time-sensitive work.`,
